...
class GastosUsuario(models.Model):
	...
	num_tarjeta_gasolina = fields.Char(string='N° Tarjeta Gasolina', help='Escribe los 4 ultomos dijitos de tu tarjeta')
	num_tarjeta_business = fields.Char(string='N° Tarjeta business', help='Escribe los 4 ultomos dijitos de tu tarjeta')